     ...
     <!-- Content Wrapper. Contains bidang content -->
      <div class="content-wrapper" >
        ...
        <section class="content">
          <form class="" enctype="multipart/form-data" action="<?php echo base_url('admin/save_bidang') ?>" method="post">
          <div class="box box-warning">
            <div class="box-body">
              <div class="form-group">
                <label for="judul_bidang">Judul bidang</label>
                <input type="text" class="form-control" id="judul_bidang" name="judul_bidang" value="<?php echo $data['judul']; ?>" />
                <input type="hidden" id="id_bidang" value="<?php echo $data['id']; ?>"/>
              </div>


              <div class="form-group">
                <label for="tugas_bidang">Tugas bidang</label>
                <textarea class="form-control" id="tugas_bidang" name="tugas_bidang"><?php echo $data['isi'];?></textarea>
              </div>
              <div class="form-group">
                <label for="fungsi_bidang">Fungsi bidang</label>
                <textarea class="form-control" id="fungsi_bidang" name="fungsi_bidang"><?php echo $data['isi'];?></textarea>
              </div>
              ...
              <div class="form-group">
                <label for="featured_image">Upload Gambar</label>
                <div class="input-group">
                  <input type="file" name="userfile" class="form-control" id="featured_image"  />
                </div>
              </div>
