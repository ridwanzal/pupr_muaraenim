...
<html>
  <head>
    <meta charset="UTF-8">
    <title> Dinas PU Bina Marga pengairan Kabupaten Muara Enim  | Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <img src="<?php echo base_url('img/pu.png') ?>" alt=""> <br>
        <a href="http://www.sandro.id/" target='_blank'><span style="color:#f39c12">Login</span> <span style="color:#00c0ef"><b style="color">Area</b></span></a>
      </div><!-- /.login-logo -->
