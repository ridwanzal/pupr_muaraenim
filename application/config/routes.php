...
$route['berita']='berita/semua';
$route['berita/(\d+)']='berita/semua/$1';
$route['berita/(\d+)[-\w]+']='berita/detail/$1';
...
$route['bidang/(\d+)/?$']='bidang/detail/$1';
$route['bidang/(\d+)[-\w]+$']='bidang/detail/$1';


$route["struktur-organisasi"]="Struktur_organisasi";
$route["about-us"]="about_us";
$route["data-infrastruktur"]="data_infrastruktur";
$route["produk-hukum"]="produk_hukum";
$route["kontak"]="kontak";
