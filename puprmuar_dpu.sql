...
--
-- Host: localhost
-- Generation Time: Apr 29, 2019 at 04:34 AM
...
(5, 'http://localhost/dpunew/an-component/media/upload-gambar-pendukung/pupr1.jpg', '', 'Pembangunan dan Realisasi Muara Enim 2019', '', ''),
(6, 'http://localhost/dpunew/an-component/media/upload-gambar-pendukung/pupr2.jpg', '', 'Menjadikan Muara Enim Kabupaten Terdepan', '', ''),
(7, 'http://localhost/dpunew/an-component/media/upload-gambar-pendukung/pupr3.jpg', '', 'Pariwisata menjadi Kunci Pengembangan Ekonomi Muara Enim', '', ''),
(8, 'http://localhost/dpunew/an-component/media/upload-gambar-pendukung/pupr4.jpg', '', 'Terciptanya Lapangan Kerja Baru ', '', ''),
(9, 'http://localhost/dpunew/an-component/media/upload-gambar-pendukung/pupr5.jpg', '', 'Pembangunan Jembatan Kabupaten Muara Enim', '', '');
...
(6, 1, 0, 'home', 'Beranda', 'http://localhost/dpunew', '_self', 'Y', 1),
(9, 1, 0, 'syarat-ketentuan', 'Berita', 'http://localhost/dpunew/index.php/berita', '_self', 'Y', 15),
(12, 1, 0, 'about-us', 'Unit Dinas', 'http://localhost/dpunew/index.php/unit_kerja', '_self', 'Y', 7),
(13, 1, 0, 'privacy', 'Produk Hukum', 'http://localhost/dpunew/index.php/produk-hukum', '_self', 'Y', 16),
(14, 1, 0, 'about-us', 'Data Infrastruktur', 'http://localhost/dpunew/index.php/data-infrastruktur', '_self', 'Y', 17),
(15, 1, 0, 'home', 'Profil Instansi', '#', '_self', 'Y', 2),
(17, 1, 15, '', 'Visi Misi', 'http://localhost/dpunew/index.php/page/1-visi-dan-misi', '_self', 'Y', 3),
(18, 1, 15, '', 'Dasar Hukum', 'http://localhost/dpunew/index.php/page/6-dasar-hukum', '_self', 'Y', 4),
(19, 1, 15, '', 'Tugas dan Fungsi', 'http://localhost/dpunew/index.php/page/2-tugas-dan-fungsi', '_self', 'Y', 5),
(20, 1, 15, '', 'Struktur Organisasi', 'http://localhost/dpunew/index.php/struktur-organisasi', '_self', 'Y', 6),
(21, 1, 12, '', 'Bidang Pembangunan Jalan Dan Jembatan', 'http://localhost/dpunew/index.php/bidang/3899-Bidang-Pembangunan-Jalan-Dan', '_self', 'Y', 9),
(22, 1, 12, '', 'Bidang Preservasi Jalan Dan Jembatan', 'http://localhost/dpunew/index.php/bidang/4454-Bidang-Preservasi-Jalan-Dan', '_self', 'Y', 10),
(23, 1, 0, 'faq', 'Galeri', 'http://localhost/dpunew/index.php/galeri', '_self', 'Y', 18),
(24, 1, 0, 'faq', 'Kontak', 'http://localhost/dpunew/index.php/kontak', '_self', 'Y', 19),
(27, 1, 12, '', 'Bidang Tata Bangunan dan Jasa Konstruksi', 'http://localhost/dpunew/index.php/bidang/3187-Bidang-Tata-Bangunan-dan-Jas', '_self', 'Y', 11),
(28, 1, 12, '', 'Bidang Air Minum dan Penyehatan Lingkungan Permukiman', 'http://localhost/dpunew/index.php/bidang/2750-Bidang-Air-Minum-dan-Penyehatan-Lingkungan', '_self', 'Y', 12),
(29, 1, 12, '', 'Bidang Sumber Daya Air', 'http://localhost/dpunew/index.php/bidang/7549-Bidang-Sumber-Daya-Air', '_self', 'Y', 13),
(30, 1, 12, '', 'Bidang Tata Ruang', 'http://localhost/dpunew/index.php/bidang/7822-Bidang-Tata', '_self', 'Y', 14),
(31, 1, 12, '', 'Sekretariat', 'http://localhost/dpunew/index.php/bidang/2783-', '_self', 'Y', 8),
(32, 1, 0, 'faq', 'FAQ', 'http://localhost/dpunew/index.php/faq', '_self', 'N', 20);
...
--
ALTER TABLE `visitor`
  MODIFY `visitor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=307;
